...
architecture STRUCTURAL of conv11x11_1024_main is
 -- Signals
signal input_data: data_array  (0 to INPUT_CHANNELS - 1);
signal input_dv	: std_logic;
signal input_fv	: std_logic;
signal s_3_data: accu_array (0 to CONV1_OUT_SIZE - 1);
signal s_3_dv	: std_logic;
signal s_3_fv	: std_logic;
signal output_data: data_array  (0 to CAST1_OUT_SIZE - 1);
...
CAST1: UnsupportedLayer
generic map (
  BITWIDTH     => BITWIDTH,
  NB_OUT_FLOWS => CAST1_OUT_SIZE
)
port map (
  in_data      => s_3_data,
  in_dv        => s_3_dv,
